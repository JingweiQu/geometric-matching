...
from geometric_matching.util.train_fn_tps_control2 import train_fn
...
if __name__ == '__main__':
    ...
    checkpoint_name = os.path.join(args.trained_models_dir, args.feature_extraction_cnn, 'jitter', 'gm' + checkpoint_suffix + '_cycle3new_no.pth.tar')
    print('Checkpoint saving name: {}'.format(checkpoint_name))

    # Set visualization
    vis = Visdom(env='TPSCycle3No')
