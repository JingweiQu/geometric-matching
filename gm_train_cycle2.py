...
from geometric_matching.util.train_fn_cycle2 import train_fn
...
if __name__ == '__main__':
    ...
    csv_file_train, train_dataset_path = get_dataset_csv(dataset_path=args.train_dataset_path, dataset=args.train_dataset,
                                                         subset='train', geometric_model=args.geometric_model)
    ...
    lambda_c = 1.0
    checkpoint_suffix += '_cycle2new_no'
