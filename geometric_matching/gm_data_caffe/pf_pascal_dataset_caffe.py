...
class PFPASCALDataset(TestDataset):
    ...
    def __init__(self, csv_file, dataset_path, output_size=(240, 240), category=None, pck_procedure='scnet'):
        super(PFPASCALDataset, self).__init__(csv_file=csv_file, dataset_path=dataset_path, output_size=output_size)
