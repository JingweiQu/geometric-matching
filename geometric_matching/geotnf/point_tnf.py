...
import numpy as np
from geometric_matching.geotnf.transformation import TpsGridGen
...
class PointTnf(object):
    ...
    def affPointTnf(self, theta, points):
        ...
        # warped_points.shape: (batch_size, 2, 400)
        return warped_points 
