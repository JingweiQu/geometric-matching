...
class CaltechDataset2(TestDataset):
    """
    ...
    def __init__(self, csv_file, dataset_path, output_size=(240, 240), normalize=None):
        super(CaltechDataset2, self).__init__(csv_file=csv_file, dataset_path=dataset_path, output_size=output_size, normalize=normalize)
