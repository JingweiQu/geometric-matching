...
class Arguments():
    ...
    def add_base_parameters(self):
        ...
        base_params.add_argument('--geometric-model', type=str, default='tps', help='Geometric model to be regressed at output: affine or tps')
        base_params.add_argument('--image-size', type=int, default=240, help='Image input size')
        base_params.add_argument('--trained-models-dir', type=str, default='geometric_matching/trained_models', help='Path to trained models folder')
        # base_params.add_argument('--trained-models-fn', type=str, default='checkpoint_adam', help='Trained model filename')
        base_params.add_argument('--seed', type=int, default=1, help='Pseudo-RNG seed')
        ...
        # base_params.add_argument('--model-aff', type=str, default='PF-PASCAL/best_checkpoint_adam_vgg_affine_PF-PASCAL.pth.tar', help='Trained affine model filename')
        # base_params.add_argument('--model-tps', type=str, default='PF-PASCAL/best_checkpoint_adam_vgg_tps_PF-PASCAL_0.3.pth.tar', help='Trained TPS model filename')
        base_params.add_argument('--model', type=str, default='PF-PASCAL/checkpoint_adam_vgg_aff_tps_PF-PASCAL_0.3.pth.tar', help='Pre-trained model filename')
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument('--start-epoch', type=int, default=1, help='Start epoch for resuming training')
    ...
    def add_train_dataset_parameters(self):
        ...
        # Training dataset
        dataset_params.add_argument('--train-dataset', type=str, default='PF-PASCAL', help='Dataset to use for training: PF-PASCAL/PascalVOC2011')
        dataset_params.add_argument('--train-dataset-path', type=str, default='geometric_matching/training_data', help='Path to folder containing training dataset')
        ...
        dataset_params.add_argument('--random-t-tps', type=float, default=0.3, help='Random transformation translation')
        ...
        dataset_params.add_argument('--eval-dataset-path', type=str, default='geometric_matching/testing_data', help='Path to validation dataset used for early stopping')
        dataset_params.add_argument('--eval-dataset-size', type=int, default=0, help='Eval dataset size limitation')
        dataset_params.add_argument('--categories', nargs='+', type=int, default=0, help='Indices of categories for eval')
    ...
    def add_test_dataset_parameters(self):
        ...
        dataset_params = self.parser.add_argument_group('dataset')
        dataset_params.add_argument('--test-dataset', type=str, default='TSS', help='Dataset to use for testing: PF-WILLOW/PF-PASCAL/Caltech-101/TSS')
        dataset_params.add_argument('--test-dataset-path', type=str, default='geometric_matching/testing_data', help='Path to folder containing training dataset')
        dataset_params.add_argument('--categories', nargs='+', type=int, default=0, help='Indices of categories for testing')
        dataset_params.add_argument('--eval-metric', type=str, default='pck', help='pck/distance')
        dataset_params.add_argument('--pck-alpha', type=float, default=0.1, help='pck margin factor alpha')
        dataset_params.add_argument('--flow-output-dir', type=str, default='geometric_matching/results/finetune/random_t_tps_0.2', help='flow output dir')
