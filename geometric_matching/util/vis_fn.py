...
def vis_fn(vis, train_loss, val_pck, train_lr, epoch, num_epochs, dataloader, theta, theta_inver, results,
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        if geometric_model == 'tps':
            ...
            theta_batch_inver = theta_inver['tps'][batch_idx].unsqueeze(0)
        elif geometric_model == 'affine':
            theta_batch = theta['aff'][batch_idx].unsqueeze(0)
            theta_batch_inver = theta_inver['aff'][batch_idx].unsqueeze(0)
