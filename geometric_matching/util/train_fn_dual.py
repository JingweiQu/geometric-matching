...
def add_watch(watch_images, image_names, batch_st, batch_tr, affTnf, tpsTnf, geoTnf, theta_aff_tps_st, theta_aff_st, theta_aff_tps_tr, theta_aff_tr, k):
    ...
    # watch_images[k, :, 0:240, :] = batch_st['source_image'][0]
    # watch_images[k + 1, :, 0:240, :] = batch_st['target_image'][0]
    # watch_images[k + 2, :, 0:240, :] = batch_triple['refer_aff'][0]
    # watch_images[k + 3, :, 0:240, :] = batch_triple['refer_tps'][0]
    # watch_images[k + 4, :, 0:240, :] = batch_triple['refer_image'][0]
    # watch_images[k + 5, :, 0:240, :] = warped_image_sr.detach()
    #
    # image_names.append('Source')
    # image_names.append('Target')
    # image_names.append('Refer_aff')
    # image_names.append('Refer_tps')
    # image_names.append('Refer')
    # image_names.append('Warped_sr')
