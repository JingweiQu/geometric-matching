...
from geometric_matching.gm_model.loss_tps2 import TransformedGridLoss, CycleLoss
...
from geometric_matching.gm_data.train_triple2 import TrainTriple
from geometric_matching.image.normalization import NormalizeImageDict
from geometric_matching.util.train_fn_tps2 import train_fn
from geometric_matching.util.test_fn_tps2 import test_fn
from geometric_matching.util.vis_fn_tps2 import vis_fn
from geometric_matching.util.test_watch_tps2 import test_watch
...
if __name__ == '__main__':
    ...
    checkpoint_name = os.path.join(args.trained_models_dir, args.feature_extraction_cnn, '3plusk', 'gm' + checkpoint_suffix + '_cycle.pth.tar')
