...
from geometric_matching.util.train_fn import train_fn
...
if __name__ == '__main__':
    ...
    checkpoint_name = os.path.join(args.trained_models_dir, args.feature_extraction_cnn, 'finetune_gm' + checkpoint_suffix + '.pth.tar')
